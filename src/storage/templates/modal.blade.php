...
<div class="modal-body">
    <div class="row g-3">
        <div class="col-md-6 order-5">
            <label>Nome</label>
            <input type="text" class="form-control" id=":MODEL_NAME_LOWER:-name" name="name" value="{{$:MODEL_NAME_LOWER:->name ?? ""}}">
        </div>
    </div>
</div>
    ...
    <div class="row w-100 justify-content-end">
        ...
        <div class="col-md-6 p-0 text-end">
            ...
            <button id=":MODEL_NAME_LOWER:-save" type="button" class="btn btn-primary"
                @isset($:MODEL_NAME_LOWER:)
                    hx-put="{{route(":MODEL_NAME_PLURAL_LOWER:.update", [$:MODEL_NAME_LOWER:])}}"
                @else
